...
exports.find = function( collection, criteria, callback ) {
  if( !read_database ) return callback( "Read database unavailable" );
  read_database.collection( collection, error_guard( callback, function( collection ) {
    collection.findOne( criteria, null, { slaveOk : true }, error_guard( callback, function( document ) {
...
exports.all = function( collection, criteria, callback ) {
  if( !read_database ) return callback( "Read database unavailable" );
  read_database.collection( collection, error_guard( callback, function( collection ) {
    collection.find( criteria, null, { slaveOk : true }, error_guard( callback, function( cursor ) {
...
exports.save = function( collection, document, callback ) {
  if( !write_database ) return callback( "Write database unavailable" );
  write_database.collection( collection, error_guard( callback, function( collection ) {
